...
int main( int argc, char * argv[] )
{
    ...
    zmq_setsockopt(pusher,ZMQ_SUBSCRIBE,"example>task?>Rein van der Linden>", 34);
    zmq_setsockopt(subscriber,ZMQ_SUBSCRIBE,"example>task!>Rein van der Linden>", 34);
    ...
    zmq_send( pusher, "example>task?>Rein van der Linden>", 34, 0 );
    printf("Send\n");
